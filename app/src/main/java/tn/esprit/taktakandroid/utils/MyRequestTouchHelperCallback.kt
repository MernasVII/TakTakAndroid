...
class MyRequestTouchHelperCallback (
    private val context: Context,
    private val adapter: CustomerRequestsAdapter,
    private val listener: MyRequestTouchHelperListener
    ) : ItemTouchHelper.Callback()
    {
        ...
        override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
            ...
            val request = adapter.requests!![position]
            when (direction) {
                ItemTouchHelper.LEFT,ItemTouchHelper.RIGHT -> {
                    listener.onRequestSwiped(request._id!!)
