...
class SPsListAdapter(
    private val fragmentManager: FragmentManager,
    private var sps: MutableList<User>
) : RecyclerView.Adapter<SPsListAdapter.SPViewHolder>() {
    ...
    override fun onBindViewHolder(holder: SPViewHolder, position: Int) {
        ...
        holder.itemView.apply {
            ...
            holder.itemView.findViewById<TextView>(R.id.tv_rate).text =
                String.format("%.1f", sp.rate)
            setOnClickListener {
